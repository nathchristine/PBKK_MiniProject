  ...
  <main class="form-container">
    <div class="form-wrapper">
      <div class="form-panel">
        ...
        <h1 class="page-heading">Add Movie</h1>
        ...
        <form method="POST" action="{{ route('movie.store') }}" enctype="multipart/form-data" class="space-y-4">
          @csrf
          ...
          <div>
            ...
            <div class="star-rating-container">
              ...
              <span id="rating-display">{{ old('rating', 0) }}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <p class="form-hint">Upload a movie poster image (JPG, PNG, etc.)</p>
          </div>
          ...
          <div>
            ...
            <textarea name="review" rows="3"
                      class="form-textarea"
                      placeholder="Your short review...">{{ old('review') }}</textarea>
          </div>

          {{-- Save and Cancel Button --}}
          <div class="form-actions">
            <button type="submit" class="navbar-add-btn">Save</button>
            <a href="{{ route('movies.index') }}" class="btn-cancel">
              Cancel
            </a>
          </div>
        </form>
